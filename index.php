...
use dimoa\Model\Category;
use dimoa\Model\Menu;

$categories = new Category();
$menuItems = new Menu();
$categories = $categories->getCategoryAll();
$menuItems = $menuItems->getMenuAndNameCategory();
...
$result_filter = (new Category())->getCategoryAll();
$result_nav = (new Category())->getCategoryAll();
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Caveat&family=Kaushan+Script&family=Montserrat:wght@400;700&family=Playfair+Display:ital,wght@0,400;0,500;1,400&display=swap"
          rel="stylesheet">
...
<div class="menu">
    ...
    foreach ($categories as $category): ?>
        ...
        <?php
        if (isset($menuByCategory[$category['Name_category']])): ?>
            <?php
            foreach ($menuByCategory[$category['Name_category']] as $menuItem): ?>
                <div class="tovar">
                    <div class="menu_card">
...
<div class="komentariya">
    ...
    <div class="modal modal1">
        <div class="modal__main">
            ...
            <h3 class="modal_text">Здравствуйте. Напишите пожалуйства причину обращения и мы с вами обязательно
                свяжемся</h3>
            <div class="content">
